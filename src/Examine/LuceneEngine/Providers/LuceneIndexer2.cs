...
//    public class LuceneIndexer2 : IndexProvider, IDisposable, IIndexReadable
//    {
//        #region Constructors
...
//        [SecuritySafeCritical]
//        protected LuceneIndexer2(IIndexCriteria indexerData, DirectoryInfo workingFolder, Analyzer analyzer, bool async)
//            : base(indexerData)
//        {
//            _disposer = new DisposableIndexer(this);
//            _committer = new IndexCommiter(this);
...
//        /// <param name="async"></param>
//        [SecuritySafeCritical]
//        protected LuceneIndexer2(IIndexCriteria indexerData, Directory luceneDirectory, Analyzer analyzer, bool async)
//            : base(indexerData)
//        {
//            _disposer = new DisposableIndexer(this);
//            _committer = new IndexCommiter(this);
...
//        /// <param name="async"></param>
//        [SecuritySafeCritical]
//        protected LuceneIndexer2(IIndexCriteria indexerData, IndexWriter writer, bool async)
//            : base(indexerData)
//        {
...
//        /// </summary>
//        [SecuritySafeCritical]
//        public override void EnsureIndex(bool forceOverwrite)
//        {
...
//        protected override void DeleteItem(string nodeId, Action<KeyValuePair<string, string>> onComplete)
//        {
//            Interlocked.Increment(ref _activeAddsOrDeletes);

//            try
//            {
//                EnqueueIndexOperation(new IndexOperation(new IndexItem(null, "", nodeId), IndexOperationType.Delete)
//                {
//                    OnComplete = () => onComplete(new KeyValuePair<string, string>(IndexNodeIdFieldName, nodeId))
//                });
